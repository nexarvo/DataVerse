...
const TopBar: React.FC<TopBarProps> = ({ isProjectView = false }) => {
  return (
    ...
    >
      {' '}
      {isProjectView && (
        <div className='ext-md font-bold text-blue-300'>DataVerse</div>
      )}
      {/* Search Bar */}
      {!isProjectView && (
      ...
      <div className='flex items-center space-x-4'>
        {isProjectView ? (
          <button className='text-gray-400 text-md hover:bg-transparent'>
            <img src={CommentIcon} alt='icon' className='h-5 w-5' />
          </button>
        ) : (
        ...
        {isProjectView ? (
          ...
          <button className='pl-2 py-1 bg-green-glass border border-green-800 text-green-300 shadow-md backdrop-blur-md rounded-sm hover:bg-green-hover transition'>
            <div className='flex items-center'>
              <svg
                width='20'
                height='20'
        ...
        <button className='pr-2 py-0.5 bg-blue-glass border border-gray-400 text-gray-300 shadow-md backdrop-blur-md rounded-sm hover:bg-green-hover transition'>
          <div className='flex items-center'>
            ...
            {/* Partition */}
            <div className='mx-2 border-l border-gray-300 h-4'></div>
